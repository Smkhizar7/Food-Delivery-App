...
let getRest = () => {
    ...
    div.innerHTML = `<h1 id="load1" class="">Loading...</h1>`;
...
let products = () => {
    ...
    div.innerHTML = `<h1 id="load2" class="">Loading...</h1>`;
...
let cartView = () => {
    ...
    div.innerHTML = `<h1 id="load2" class="cloading">Loading...</h1>`;
    setTimeout(() => {
        load2.setAttribute("class", "hidden");
        ...
        for (let k = 0; k < cartItems.length; k++) {
            content += `<tr>
                    <td scope="col">${i}</td>
                    <td scope="col"><img src="${cartItems[k].Item_Image_URL}" width="100px" heigth="100px"></td>
...
let order = () => {
    ...
    div.innerHTML = `<h1 id="load3" class="cloading">Loading...</h1>`;
    let content;
    let i = 1;
    ...
    firebase.database().ref("orders").on("child_added", (data) => {
        ...
        for (let key in rest) {
            if (rest[key].Customer_Id == userId) {
                content += `<tr>
                            <td scope="row">${i}</td>
                            <td><img src="${rest[key].Item_Image_URL}" width="100px" heigth="100px"></td>
